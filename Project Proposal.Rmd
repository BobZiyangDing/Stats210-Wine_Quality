...
###**Explanatory Variables:**
  + **fixed.acidity (g(tartaric acid)/dm3)**: the amount of acid in wine that's not volatile
  + **volatile.acidity(g(acetic acid)/dm3)**: the amount of acid in wine that's volatile
  + **citric.acid (g/dm3)**: the quantity of citric acid, which add freshness flavor to wine
  + **residual.sugar (g/dm3)**: the amount of sugar left after fermatation stops
  + **chlorides (g(sodium chloride)/dm3)**: the amount of salt in the wine
  + **free.sulfure.dioxide  (mg/dm3)**: the free form of SO2 exists in equilibrium between molecular SO2 (as a dissolved gas) and bisulfite ion
  + **total.sulfur.dioxide  (mg/dm3)**: amount of free and bound forms of S02
  + **density (g/cm3)**: the density, which is related to proportion of water and other solvent.
  + **pH**: the indicator showing the acidicity or basic property. ranging from 0 to 14.
  + **sulphates (g(potassium sulphate)/dm3)**: a wine additive which can contribute to sulfur dioxide gas (S02) levels
  + **alcohol (vol.%)**: percent of alcohol
